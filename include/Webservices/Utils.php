...
function vtws_CreateCompanyLogoFile($fieldname)
{
	...
	$allowedFileTypes = ['jpeg', 'png', 'jpg', 'pjpeg', 'x-png'];
...
/**
 * vtws_validateConvertEntityMandatoryValues
 *
 * @param  mixed $entity
...
/**
 * vtws_getConvertEntityFieldInfo
 *
 * @param  mixed $module
...
function registerWSAPI($operationInfo)
{
	...
	$query = 'SELECT 1 FROM vtiger_ws_operation WHERE name=?';
	$result = $adb->pquery($query, [$operationInfo['name']]);
