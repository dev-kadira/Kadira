...
class Accounts extends CRMEntity
{
	...
	public $tab_name_index = ['vtiger_crmentity'=>'crmid', 'vtiger_account'=>'accountid', 'vtiger_accountbillads'=>'accountaddressid', 'vtiger_accountshipads'=>'accountaddressid', 'vtiger_accountscf'=>'accountid'];
	/**
	...
	public $sortby_fields = ['accountname', 'bill_city', 'website', 'phone', 'smownerid'];
	...
	public $related_module_table_index = [
		'Contacts'         => ['table_name' => 'vtiger_contactdetails', 'table_index' => 'contactid', 'rel_index' => 'accountid'],
		'Potentials'       => ['table_name' => 'vtiger_potential', 'table_index' => 'potentialid', 'rel_index' => 'related_to'],
		'Quotes'           => ['table_name' => 'vtiger_quotes', 'table_index' => 'quoteid', 'rel_index' => 'accountid'],
		'SalesOrder'       => ['table_name' => 'vtiger_salesorder', 'table_index' => 'salesorderid', 'rel_index' => 'accountid'],
		'Invoice'          => ['table_name' => 'vtiger_invoice', 'table_index' => 'invoiceid', 'rel_index' => 'accountid'],
		...
		'Calendar'         => ['table_name' => 'vtiger_seactivityrel', 'table_index' => 'activityid', 'rel_index' => 'crmid'],
	 ...
	 * @param mixed $encountered_accounts
	 */
	 ...
	 * @param mixed $actions
	 */
	public function get_purchaseorder($id, $cur_tab_id, $rel_tab_id, $actions = false)
	{
		global $log, $singlepane_view,$currentModule,$current_user;
		...
		$userNameSql = getSqlForNameInDisplayFormat(['first_name'=> 'vtiger_users.first_name', 'last_name' => 'vtiger_users.last_name'], 'Users');
		$query = "SELECT vtiger_purchaseorder.*, vtiger_crmentity.crmid, vtiger_crmentity.smownerid,
			case when (vtiger_users.user_name not like '') then ${userNameSql} else vtiger_groups.groupname end as user_name
			...
			LEFT JOIN vtiger_users ON vtiger_crmentity.smownerid = vtiger_users.id
			WHERE vtiger_crmentity.deleted = 0
			AND vtiger_purchaseorder.accountid = " . $id;
	...
	public function get_emails($id, $cur_tab_id, $rel_tab_id, $actions = false)
	{
		...
		$entityIds = array_merge([$id], $this->getRelatedContactsIds(), $this->getRelatedPotentialIds($id), $this->getRelatedTicketIds($id));
		$entityIds = implode(',', $entityIds);
	...
	{
		$rel_tables = [
			'Contacts'   => ['vtiger_contactdetails'=>['accountid', 'contactid'], 'vtiger_account'=>'accountid'],
			'Potentials' => ['vtiger_potential'=>['related_to', 'potentialid'], 'vtiger_account'=>'accountid'],
			'Quotes'     => ['vtiger_quotes'=>['accountid', 'quoteid'], 'vtiger_account'=>'accountid'],
			'SalesOrder' => ['vtiger_salesorder'=>['accountid', 'salesorderid'], 'vtiger_account'=>'accountid'],
			'Invoice'    => ['vtiger_invoice'=>['accountid', 'invoiceid'], 'vtiger_account'=>'accountid'],
			'Calendar'   => ['vtiger_seactivityrel'=>['crmid', 'activityid'], 'vtiger_account'=>'accountid'],
			...
			'Emails'     => ['vtiger_seactivityrel'=>['crmid', 'activityid'], 'vtiger_account'=>'accountid'],
		];
	...
	public function generateReportsSecQuery($module, $secmodule, $queryPlanner)
	{
		...
		$matrix->setDependency('vtiger_account', ['vtiger_crmentityAccounts', ' vtiger_accountbillads', 'vtiger_accountshipads', 'vtiger_accountscf', 'vtiger_accountAccounts', 'vtiger_email_trackAccounts']);
	...
	public function get_merged_list($id, $cur_tab_id, $rel_tab_id, $actions = false)
	{
		...
		if ($numOfFields > 0) {
			...
			$query .= " WHERE vtiger_crmentity.deleted = 0 AND ( ({$other->table_name}.${dependentColumn} = ${id}) ";
