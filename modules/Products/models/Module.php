...
class Products_Module_Model extends Vtiger_Module_Model
{
	...
	{
		return 'SELECT vtiger_pricebook.pricebookid, vtiger_pricebook.bookname, vtiger_pricebook.active, vtiger_crmentity.crmid, 
	...
	public function getExportQuery($focus, $query)
	{
		...
		return implode(',', $columnFields) . ' FROM ' . $splitQuery[1];
	}
	 ...
	 * @return <Array>
	 */
	public function areChildProducts($productIdsList = [])
	{
		if ($productIdsList) {
