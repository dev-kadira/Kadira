...
class Settings_Workflows_Field_Model extends Vtiger_Field_Model
{
	...
	{
		return [
			'string'        => ['is', 'is not', 'contains', 'does not contain', 'starts with', 'ends with', 'has changed', 'has changed to', 'has changed from', 'is empty', 'is not empty'],
			...
			'picklist'      => ['is', 'is not', 'starts with', 'ends with', 'contains', 'does not contain', 'has changed', 'has changed to', 'has changed from', 'is empty', 'is not empty'],
			'multipicklist' => ['is', 'is not', 'contains', 'does not contain', 'has changed', 'has changed to'],
			'datetime'      => ['is', 'is not', 'has changed', 'before', 'after', 'is today', 'is tomorrow', 'is yesterday', 'less than hours before', 'less than hours later',
			...
			'date' => ['is', 'is not', 'has changed', 'between', 'before', 'after', 'is today', 'is tomorrow', 'is yesterday', 'less than days ago', 'more than days ago', 'less than days later',
